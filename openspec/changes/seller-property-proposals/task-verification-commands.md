...
| C5B2 / U6 (after C5B1 merges) | `pnpm --filter @viewpro/api exec vitest run test/property-proposal-eligibility-race.spec.ts` (repeat) | Guarded real-PostgreSQL eligibility races and barrier cleanup |
