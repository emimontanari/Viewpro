...
| C2B2 (mandatory before C3) | `pnpm --filter @viewpro/api exec vitest run test/property-proposal-cleanup.spec.ts` | Deferred reusable cleanup helper and exhaustive direct matrix only; this command remains pending until C2B2 implementation. |
