...
- [x] Manually close issue #523 only after archive eligibility confirms all 34 scenarios, browser/accessibility proof, protected boundaries, and no unresolved blocker. <!-- sdd-owner: parent -->
