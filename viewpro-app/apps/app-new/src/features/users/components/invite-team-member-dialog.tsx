    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-lg'>
        <DialogHeader>
          ...
          <DialogDescription>
            Creá una invitación para sumar un encargado o vendedor al equipo. El link queda abajo
            para copiar y compartir; también intentamos enviarlo por email.
          </DialogDescription>
        </DialogHeader>
        ...
        <form id='invite-team-member-form' className='space-y-5' noValidate onSubmit={handleSubmit}>
          ...
          {invitationUrl ? (
            <div className='bg-muted/40 rounded-lg border border-dashed p-4 text-sm'>
              <p className='font-medium'>Link de la invitación:</p>
              <a
                href={invitationUrl}
