...
> **IMPORTANT:** Always run commands using the project's package runner: `pnpm dlx shadcn@latest` for this project. Examples below use `npx shadcn@latest` but substitute the correct runner for the project.
...
| `packageManager`     | `string`  | Detected package manager; this project uses `pnpm`                 |
