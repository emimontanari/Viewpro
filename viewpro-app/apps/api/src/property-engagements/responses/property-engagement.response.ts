...
export type PropertyEngagementResponse = ReturnType<
	typeof mapPropertyEngagement
>;

export function mapPropertyEngagement(
	...
	return {
		...
		archivedAt: engagement.archivedAt?.toISOString() ?? null,
		archivedByUserId: engagement.archivedByUserId,
		archiveReason: engagement.archiveReason,
		property: {
