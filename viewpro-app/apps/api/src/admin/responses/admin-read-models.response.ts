import type { AdminActivityRecord, AdminTenantRecord } from '../admin-read-models.repository'
...
export function mapAdminActivityToResponse(activity: AdminActivityRecord): AdminActivityResponse {
  return {
    id: activity.id,
