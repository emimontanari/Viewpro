import type { AnalyticsActorType, AnalyticsEventName, Prisma, TenantStatus } from '@prisma/client'

export const ADMIN_READ_MODELS_REPOSITORY = Symbol('ADMIN_READ_MODELS_REPOSITORY')
