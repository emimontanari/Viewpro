...
describe('restore migration contract', () => {
  ...
  it('folds the exact 28 product and 6 platform repository tables', () => {
...
describe('restore schema parity', () => {
  ...
  it('emits complete product and platform repository receipts', async () => {
    for (const [migrationDir, count] of [[join(appRoot, 'apps/api/prisma/migrations'), 28], [join(appRoot, 'apps/viewpro-api/prisma/migrations'), 6]]) {
